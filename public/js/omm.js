...
for (let i = 0; i < elements.length; i++) {
  ...
  //     const container = document.querySelector('.sec-4 .row:nth-child(2)');
  //     container.innerHTML = '';
  ...
  //     { title: "Maleficent", year: 2014, image: "asset/images/poster/maleficent.jpg" },
  //     { title: "Maleficent: Mistress of Evil", year: 2019, image: "asset/images/poster/maleficent2.jpg" },
  //     { title: "The Lion King", year: 2019, image: "asset/images/poster/lionking.jpg" },
  //     { title: "Beauty and the Beast", year: 2017, image: "asset/images/poster/beautyandthebeast.jpg" }
  // ];
